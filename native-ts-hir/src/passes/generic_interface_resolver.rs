...
use crate::untyped_hir::visit::{BreakOrContinue, Visit, Visitor};
use crate::untyped_hir::{DeepClone, InterfaceType, Type};
...
fn test_generic_interface_resolver() {
    use crate::untyped_hir::{GenericId, GenericParam, InterfaceProperty, InterfaceType};
    ...
    let mut iface = Type::Interface {
        ...
        interface: Rc::new(InterfaceType {
            ...
            props: vec![InterfaceProperty {
                name: crate::PropName::Ident("myfield".into()),
                optinal: false,
                readonly: false,
                ty: Type::Union(vec![
                    Type::Generic(GenericId(0)),
                    Type::Generic(GenericId(1)),
                    Type::Generic(GenericId(2)),
                ]),
            }],
            methods: vec![],
        }),
